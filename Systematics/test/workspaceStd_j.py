...
for tag in tagList: 
  ...
  for systlabel in systlabels:
      ...
      # joo add varibles
      currentVariables += [
                           #"dipho_leadPt                   :=leadingPhoton.pt",
                           #"dipho_subleadPt                :=subLeadingPhoton.pt",
                           ...
                           # For jet pt and eta there are easy-access variables already
                           "dijet_leadPt         := VBFMVA.dijet_LeadJPt",
                           "dijet_leadEta        := VBFMVA.dijet_leadEta",
                           "dijet_subleadPt      := VBFMVA.dijet_SubJPt",
                           "dijet_subleadEta     := VBFMVA.dijet_subleadEta ",
                           # Full Lorentz vectors are available, pull Phi and E from there
